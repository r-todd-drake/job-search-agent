...
ACQUAINTANCE = {
    **BASE,
    "warmth": "Acquaintance",
    "notes": "Met at AUSA Annual Meeting 2024, discussed next-gen air defense sensor sustainment",
}

FORMER_COLLEAGUE = {
    **BASE,
    "warmth": "Former Colleague",
    "notes": "Worked together at Vector Defense Systems, Advanced Concepts group, 2019-2022",
}

STRONG = {
    **BASE,
    "warmth": "Strong",
    "notes": "Close colleague from Vector Defense Systems; collaborated on multiple capture efforts",
}
