...
def test_strip_pii_removes_location(monkeypatch):
    monkeypatch.setenv('CANDIDATE_LOCATION', 'San Diego, CA')
    result = strip_pii('Candidate based in San Diego, CA seeking roles.')
    assert 'San Diego, CA' not in result
