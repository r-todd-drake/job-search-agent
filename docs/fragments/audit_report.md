...
context/SCRIPT_INDEX.md, context/INTERFACE_MAP.md, context/STAGE_FILES.md,
...
- context/SCRIPT_INDEX.md, INTERFACE_MAP.md, STAGE_FILES.md, SCHEMA_REFERENCE.md — already single-source
