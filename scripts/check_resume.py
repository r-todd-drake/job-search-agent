...
def _build_system_prompt():
    ...
    return (
        f"You are a resume quality reviewer for a {label} candidate. "
...
GAP_STOP_WORDS = {
    ...
    'AI',  # too generic – company names containing 'AI' would produce false positives
}
...
def run_layer2(client, resume_text, gaps_section, banned_section):
    ...
    """
    # Gaps and banned sections come from CANDIDATE_BACKGROUND.md unstripped
    gaps_section = strip_pii(gaps_section)
    banned_section = strip_pii(banned_section)
